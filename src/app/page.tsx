        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 md:grid-cols-12 gap-12">
          ...
          <div className="md:col-span-2">
            ...
            <div className="flex gap-4">
              ...
              <a href="#" className="h-10 w-10 rounded-full bg-white/10 flex items-center justify-center hover:bg-[#0d9488] transition-colors">IG</a>
              <a href="#" className="h-10 w-10 rounded-full bg-white/10 flex items-center justify-center hover:bg-[#0d9488] transition-colors">YT</a>
              <a href="#" className="h-10 w-10 rounded-full bg-white/10 flex items-center justify-center hover:bg-[#0d9488] transition-colors">FB</a>
            </div>
          </div>
        </div>
      </footer>
