				...
				<div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
					...
					<div>
						...
						<p className="text-gray-600 text-lg mb-10 leading-relaxed max-w-lg">
							Pusat pendidikan Quran untuk anak-anak di Wahana Pondok Gede
						</p>
					...
					<div className="grid grid-cols-2 gap-4">
						<div className="col-span-2 relative h-[350px] rounded-[40px] overflow-hidden shadow-2xl">
							<Image
								src="/images/layanan/tahfidz-1.png"
								alt="Main Service"
								fill
						...
						<div className="relative h-[200px] rounded-[30px] overflow-hidden shadow-xl">
							<Image
								src="/images/layanan/tahfidz-2.png"
								alt="Activity"
								fill
						...
						<div className="relative h-[200px] rounded-[30px] overflow-hidden shadow-xl">
							<Image
								src="/images/layanan/tahfidz-3.png"
								alt="Activity"
								fill
								className="object-cover"
							/>
