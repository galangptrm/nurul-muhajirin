      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center">
          ...
          <Link href="/" className="flex items-center gap-3 group">
            <div className="h-10 w-10 bg-[#eab308] rounded-full flex items-center justify-center text-[#0a2e24] font-bold text-xl group-hover:scale-105 transition-transform shadow-md">
              M
            </div>
          ...
          {/* Desktop Menu */}
          <div className="md:flex items-center space-x-8 drop-shadow-md">
